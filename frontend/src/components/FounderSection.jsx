    ...
    <section className=" dark:bg-gray-100 dark:text-gray-800">
      <div className="container flex flex-col items-center p-4 mx-auto space-y-6 md:p-8">
        ...
        <p className="px-6 py-2 text-2xl font-semibold text-center sm:font-bold sm:text-3xl md:text-4xl lg:max-w-2xl xl:max-w-4xl dark:text-gray-700">
          Shivam, the mastermind behind BurgerWalla, transforms every meal into
          an unforgettable culinary experience. With his passion for quality and
          innovation, he's created a food haven loved by all. Join us in
          savoring Shivam's culinary creations and indulge in the magic of
          BurgerWalla!"
        </p>
